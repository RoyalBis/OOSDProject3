...
public class CustomerProvider extends EntityProvider
{
    ...
    public PreparedStatement PrepareUpdate(PreparedStatement stmt, IEntity newEntity, IEntity oldEntity) throws SQLException
    {
        ...
        stmt.setString(5, newCustomer.getCustHomePhone());
        stmt.setString(6, newCustomer.getCustBusPhone());
        stmt.setString(7, newCustomer.getCustEmail());
        stmt.setInt(8, newCustomer.getAgentId());
        stmt.setInt(9, oldCustomer.getAgentId());
        stmt.setString(10, oldCustomer.getCustFirstName());
        stmt.setString(11, oldCustomer.getCustLastName());
        stmt.setString(12, oldCustomer.getCustAddress());
        stmt.setString(13, oldCustomer.getCustCity());
        stmt.setString(14, oldCustomer.getCustProv());
        stmt.setString(15, oldCustomer.getCustPostal());
        stmt.setString(16, oldCustomer.getCustCountry());
        stmt.setString(17, oldCustomer.getCustHomePhone());
        stmt.setString(18, oldCustomer.getCustBusPhone());
        stmt.setString(19, oldCustomer.getCustEmail());
        stmt.setInt(20, oldCustomer.getAgentId());
        return stmt;
    }
}
